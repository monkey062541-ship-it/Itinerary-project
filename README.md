...
| `最近行程` | 未來七天 |
| `全部行程` | 所有已登錄的行程 |
| `3/27`、`3月27日`、`2027-03-27` | 指定日期 |
| `說明` | 指令一覽 |

語助詞會自動忽略，所以「今天有什麼行程？」一樣看得懂。

只寫月日、沒寫年份時，若該日期今年已經過了就視為明年——所以現在打「3/27」查到的是 2027 年那天。要查過去的日期請寫完整年份。

**沒命中關鍵詞就完全不回應**，這樣拉進群組才不會插嘴別人的對話。

## 怎麼改行程

編輯 `data/events.json`，push 到 GitHub 後 Render 會自動重新部署。

目前收錄：**2027 東京櫻花之旅**（2027/3/27–3/31），來源為
`三小國規劃/2027東京櫻花之旅_規劃交接文件.md`。
